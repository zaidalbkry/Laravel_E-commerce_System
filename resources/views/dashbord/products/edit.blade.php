		...
		<div class="card">
			<div class="card-body">
				<div class="col-lg-12 margin-tb">
					...
					<form autocomplete="off" class="parsley-style-1" id="selectForm2" name="selectForm2"
					...
					<div class="">
						<div class="row mg-b-20">
							<div class="parsley-input col-md-6" id="fnWrapper">
								...
								<input class="form-control form-control-sm mg-b-20" autocomplete="off" name="name" value="{{ $product->name }}" type="text">
							</div>
					...
					<div class="row mg-b-20">
						...
						<div class="parsley-input col-md-12 mg-t-20 mg-md-t-0" id="lnWrapper">
							...
							<textarea class="form-control form-control-sm mg-b-20" name="description" id=""  rows="10">{{ $product->description }}</textarea>
						</div>
