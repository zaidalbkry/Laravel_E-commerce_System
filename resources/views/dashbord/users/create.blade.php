	...
	<div class="col-lg-12 col-md-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form class="parsley-style-1" id="selectForm2" name="selectForm2" action="{{route('users.store')}}" method="post" autocomplete="off">
					@csrf
					...
					<div class="">
						...
						<div class="row mg-b-20">
							<div class="parsley-input col-md-12" id="roleWrapper">
								...
								<select class="form-control form-control-sm mg-b-20" name="role">
					...
					<div class="row mg-b-20">
						<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
							...
							<input class="form-control form-control-sm mg-b-20" name="password" required="" type="password">
						</div>

						<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
							<label>Confirm Password: <span class="tx-danger">*</span></label>
							<input class="form-control form-control-sm mg-b-20" name="confirm-password" required="" type="password">
						</div>
					</div>
